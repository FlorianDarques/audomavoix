        ...
        <div class="inscription_box">
            ...
            <form action="" method="post">
                ...
                <div class="form_inscription_group">
                    ...
                    <label for="name" class="form_inscription_label">Nom</label>
                ...
                <div class="form_inscription_group">
                    ...
                    <label for="surname" class="form_inscription_label">Prénom</label>
                ...
                <div class="form_inscription_group">
                    ...
                    <label for="age" class="form_inscription_label">Âge</label>
                ...
                <div class="form_inscription_group">
                    ...
                    <label for="email" class="form_inscription_label">Adresse email</label>
                ...
                <div class="form_inscription_group">
                    ...
                    <label for="password" class="form_inscription_label">Mot de passe</label>
                ...
                <div class="form_inscription_group">
                    ...
                    <label for="password" class="form_inscription_label">Confirmer mdp</label>
